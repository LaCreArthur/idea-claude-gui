      ...
      <div className="confirm-dialog rewind-dialog" onClick={(e) => e.stopPropagation()}>
        <div className="confirm-dialog-header">
          <h3 className="confirm-dialog-title">
            <span className="rewind-icon">&#x21BA;</span> Rewind Files to Previous State
          </h3>
        </div>
        <div className="confirm-dialog-body">
          {isLoading ? (
            <div className="rewind-loading">
              ...
              <span className="rewind-loading-text">Restoring files...</span>
            </div>
          ) : (
            <>
              <div className="rewind-target">
                <div className="rewind-target-label">Rewind to:</div>
              ...
              <div className="rewind-warning">
                ...
                <div className="rewind-warning-content">
                  <div className="rewind-warning-title">Impact:</div>
                  <ul className="rewind-warning-list">
                    <li>Will restore files to their state at this message</li>
                    <li>
                      Changes made after this point will be lost
                      {request.messagesAfterCount > 0 && (
                        <span className="rewind-affected-count">
                          ({request.messagesAfterCount} messages affected)
                        </span>
                      )}
                    </li>
                    <li>Conversation history will be kept</li>
                  </ul>
                </div>
              </div>
